...
import {
    adminReducer, localeReducer,
    crudSaga, CrudRoute, TranslationProvider, simpleRestClient
} from 'admin-on-rest';
...
const resources = [
    ...
    { name: 'timelines', list: TimeLinePage },
];


const LayoutWithTitle = withProps({ title: 'Cognac' })(Layout);
...
const App = () => (
    ...
    <Resource name="users" list={UserList} icon={UserIcon} />*/}
                    ...
                    <Route path="timelines" list={TimeLinePage}>
                        {/*<Route path="/:id" component={TimeLinePage} />*/}
                    </Route>
                </Route>
            </Router>
        </TranslationProvider>
